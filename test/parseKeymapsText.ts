...
describe("parseKeymapsText", () => {
    ...
    it("the ergodox", () => {
        ...
        [
            ["KC_EQL","KC_1","KC_2","KC_3","KC_4","KC_5","KC_LEFT","KC_DELT","KC_Q","KC_W","KC_E","KC_R","KC_T","TG(SYMB)","KC_BSPC","KC_A","KC_S","KC_D","KC_F","KC_G","KC_LSFT","CTL_T(KC_Z)","KC_X","KC_C","KC_V","KC_B","ALL_T(KC_NO)","LT(SYMB,KC_GRV)","KC_QUOT","LALT(KC_LSFT)","KC_LEFT","KC_RGHT","ALT_T(KC_APP)","KC_LEFT_GUI","KC_HOME","KC_SPC","KC_BSPC","KC_END","KC_RGHT","KC_6","KC_7","KC_8","KC_9","KC_0","KC_MINS","TG(SYMB)","KC_Y","KC_U","KC_I","KC_O","KC_P","KC_BSLS","KC_H","KC_J","KC_K","KC_L","LT(MDIA, KC_SCLN)","GUI_T(KC_QUOT)","MEH_T(KC_NO)","KC_N","KC_M","KC_COMM","KC_DOT","CTL_T(KC_SLSH)","KC_RSFT","KC_UP","KC_DOWN","KC_LBRC","KC_RBRC","KC_FN1","KC_LEFT_ALT","CTL_T(KC_ESC)","KC_PAGE_UP","KC_PGDN","KC_TAB","KC_ENT"],
